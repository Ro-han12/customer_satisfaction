...
def run_deployment(config: str, min_accuracy: float):
    ...
    if deploy:
        continous_deployment_pipeline(data_path='/Users/rohansridhar/Desktop/customer_satisfaction/data/olist_customers_dataset.csv',min_accuracy=min_accuracy, workers=3, timeout=60)
